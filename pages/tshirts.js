      ...
      <section className="text-gray-400 bg-gray-900 body-font">
        <div className="container px-5 py-12 mx-auto">
          <div className="flex flex-wrap -m-4">
            {tshirts.length == 0 && <p className='flex mx-auto px-10 items-center text-xl min-h-[40vh]'>Sorry to inform you that all of the TSHIRTS are currently out of stock. New stock is coming soon.</p>}
            {tshirts.map((item) => {
              return (
