        ...
        <div className="container px-5 py-24 mx-auto flex flex-col">
          <div className="lg:w-4/6 mx-auto">
            ...
            <div className='hidden md:flex items-center justify-center'>
              <h2 className='text-4xl text-white font-medium'>Welcome to SWAGSTOAR!</h2>
            </div>
            <p className='flex md:w-1/2 text-center mx-auto py-8 items-center justify-center'>This webapp is built just for my portfolio and to practice, build full stack skills and to learn more. This entire webapp was built as a portfolio project. This website is powered by NextJs + React + MongoDB (MENN stack). For the server side logic, I used NextJs built in SSR, and used TailwindCss for styling ;) !</p>
