      ...
      <section className="text-gray-400 bg-gray-900 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="docker-kill" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://cdn.shopify.com/s/files/1/0437/7057/7061/products/40fde45bbac3dd55ea69ddc14a2152bc_1024x1024@2x.jpg?v=1597721564" />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">SWAGSTOAR</h2>
              <h1 className="text-white text-3xl title-font font-medium mb-1">Docker Kill - Unisex Jersey Short Sleeve Tee</h1>
              <div className="flex mb-4">
                <span className="flex items-center">
                  <svg fill="currentColor" stroke="currentColor" stroke-line-cap="round" stroke-line-join="round" strokeWidth="2" className="w-4 h-4 text-purple-400" viewBox="0 0 24 24">
                  ...
                  <svg fill="none" stroke="currentColor" stroke-line-cap="round" stroke-line-join="round" strokeWidth="2" className="w-4 h-4 text-purple-400" viewBox="0 0 24 24">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                  </svg>
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-800 mb-5">
                ...
                <div className="flex ml-6 items-center">
                  ...
                  <div className="static">
                    ...
                    <span className="absolute right-[28rem] top-40 h-full w-10 text-center text-gray-600 pointer-events-none flex items-center justify-center">
                      <svg fill="none" stroke="currentColor" stroke-line-cap="round" stroke-line-join="round" strokeWidth="2" className="w-4 h-4" viewBox="0 0 24 24">
              ...
              <div className="flex">
                <span className="title-font font-medium text-2xl text-white">$18.00</span>
                ...
                <button onClick={() => { addToCart(slug, 1, 18.00, 'Docker Kill - Unisex Jersey Short Sleeve Tee', 'XL', 'red'), toggleCart() }} className="flex text-sm ml-4 text-white bg-purple-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-purple-600 rounded">Add to Cart</button>
              ...
              <div className="flex flex-col my-5">
                <div className="pin flex space-x-4 text-sm">
                  <input onChange={onChangePin} placeholder=' enter your pincode' type="text" id="footer-field" name="footer-field"
