      ...
      <section className="text-gray-400 bg-gray-900 body-font overflow-hidden">
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt={product.title} className="lg:w-1/2 w-full h-auto object-cover object-center rounded" src={product.image} />
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-800 mb-5">
                ...
                <div className="flex ml-6 items-center">
                  ...
                  <div className="static">
                    <select className="rounded border border-gray-700 focus:ring-2 focus:ring-purple-900 bg-transparent appearance-none py-2 focus:outline-none focus:border-purple-500 text-white px-4">
