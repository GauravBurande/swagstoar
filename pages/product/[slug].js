          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button onClick={() => { addToCart(slug, 1, 18.99, 'Docker Kill', 'XL', 'red') }} className="flex text-sm ml-4 text-white bg-purple-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-purple-600 rounded">Add to Cart</button>
              ...
              <div className="flex flex-col my-5">
                <div className="pin flex space-x-4 text-sm">
                  <input onChange={onChangePin} placeholder=' enteryour pincode' type="text" id="footer-field" name="footer-field"
