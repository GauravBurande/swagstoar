...
export default function Home() {
  return (
    <>
      <div>
        <img src="/coder.png" alt="Swagstoar" />
      </div>
      <section className="text-gray-400 body-font bg-gray-900">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-white">FEATURED COLLECTION</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-opacity-80">for developers. by developers.</p>
          </div>
